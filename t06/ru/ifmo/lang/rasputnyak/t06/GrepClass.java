    ...
    public static void main(String[] args) {
        try {
            if (args.length == 3) {
                ...
                if (args[0].equals("-o")) {
                    System.out.println(grepClass.findLines(args[1]));
                }
                if (args[0].equals("-v")) {
                    System.out.println(grepClass.findInvertMatch(args[1]));
                }
            }
            else {
                GrepClass grepClass = new GrepClass(new BufferedInputStream(new FileInputStream(args[1])));
                System.out.println(grepClass.findParts(args[0]));
            }
